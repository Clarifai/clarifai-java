...
public final class DefaultModels {
  ...
  @NotNull private AtomicReference<DemographicModel> demographicsModel;
  ...
  public DefaultModels(@NotNull BaseClarifaiClient client) {
    ...
    demographicsModel = create(ModelType.DEMOGRAPHIC_MODEL, client, "c0c0ac362b03416da06ab3fa36fb58e3", "age-gender-ethnicity");
  }
  ...
  @NotNull public DemographicModel demographicsModel() { return demographicsModel.get(); }
}
